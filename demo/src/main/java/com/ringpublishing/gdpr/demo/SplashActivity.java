...
public class SplashActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            final Intent startWelcomeScreenIntent = RingPublishingGDPRActivity.createShowWelcomeScreenIntent(this);
            // Option to open advanced settings view
            //RingPublishingGDPRActivity.createShowSettingsScreenIntent(this);
