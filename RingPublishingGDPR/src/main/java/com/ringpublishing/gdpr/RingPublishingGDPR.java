...
public final class RingPublishingGDPR
{
    ...
    /**
     * On first application launch this method return false.
     * Next time will return information about last consent verification check.
     * @return true when consents are old or invalid.
     */
